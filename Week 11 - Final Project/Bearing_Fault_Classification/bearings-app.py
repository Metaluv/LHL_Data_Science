...
penguins_raw = pd.read_csv('../../../../app_8_classification_penguins/penguins_cleaned.csv')
...
load_clf = pickle.load(open('../../../../app_8_classification_penguins/penguins_clf.pkl', 'rb'))
